...
RUN mkdir -pv /opt/soft && cd /opt/soft && git clone https://github.com/Imagick/imagick && cd imagick && /usr/local/php/bin/phpize && ./configure  --with-php-config=/usr/local/php/bin/php-config  && make && make install && rm -rf /opt/soft
